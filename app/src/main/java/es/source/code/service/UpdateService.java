...
//                        .build();
                ...
                remoteViews.setTextViewText(R.id.notification_text_view,"新品上架："+foodList.get(0).getFoodName()+" "+foodList.get(0).getFoodPrice()+"元    "+foodList.get(0).getFoodCategory());//设置子控件显示
